...
Before that, I spent **5 years** architecting **ML platforms, data/feature systems, distributed training pipelines, and simulation‑driven AI workflows**.

My work sits at the intersection of **platform engineering, AI infrastructure, and applied LLM systems**.

---

## 🧭 **What I Focus On (Principal/Architect Lens)**
...
AWS, Kubernetes, Docker, Terraform, GitOps, distributed computing, observability (Prometheus/Grafana), secure ML deployments

**Programming & Data Systems:**  
Python (FastAPI, async/await), PyTorch, SQL/NoSQL, vector databases (Milvus/FAISS), ETL pipelines
...
## 🌱 I’m currently learning  
- Advanced **LLM safety**, adversarial evaluation, and red‑teaming  
- High‑performance inference (TensorRT‑LLM, speculative decoding)  
...
## 🤔 I’m looking for help with  
- Benchmarking LLM inference across GPU architectures  
- Best practices for **LLM cost governance** in enterprise settings
